...
const returnNames = (arr) => {
    // Solution code here...
    let arr2=[];
    const indexed = starWarsData.reduce( (acc, val, idx) => {
     // acc[val.name] = val.url;
     const map1 = starWarsData.map(x=>acc[val.name] );
...
const reversedString = (str) => {
    // Solution code here...
    let arr=[1,2,3,4,5,6,7,9,100]
      let arr2=[];
      arr2.push(str);
     const indexed = arr2.reduce( (acc, val, idx) =>{
       
    // console.log('idx',idx);  
  // console.log('1',str);
     const spliter = str.split('');
    //  console.log('2',str);
     console.log('3',spliter,idx);
     val=spliter;
