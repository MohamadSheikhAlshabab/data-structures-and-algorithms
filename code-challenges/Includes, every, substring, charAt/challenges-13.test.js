...
const firstLetters = (arr) => {
  ...
  let firstLetter=element.charAt(0);
   ...
   arrOfFirstLetters.push(firstLetter);
   console.log( arrOfFirstLetters );
  })
  return arrOfFirstLetters;
};
...
const findHappiness = (arr) => {
  // Solution code here...
  let arrOffindHappiness=[];
  arr.forEach(element =>{
  let findHappy=element.includes(':)');
   console.log( findHappy );
   console.log( element );
   if (findHappy === true){

   arrOffindHappiness.push(element);
   console.log( arrOffindHappiness );
   }
  })
  return arrOffindHappiness;
};
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  let arrOfstandardizePhoneNumbers=[];
  let reg = /\D+/g;
arr.forEach(element =>{
let match = element.search(reg);
console.log(match);
let standardizePhoneNumber=arr.includes(reg);
console.log( standardizePhoneNumber );
console.log( element );
if (standardizePhoneNumber === true){

arrOfstandardizePhoneNumbers.push(element);
console.log( arrOfstandardizePhoneNumbers );
}
})
return arrOfstandardizePhoneNumbers;
};
