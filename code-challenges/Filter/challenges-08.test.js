...
const oddValues = (arr) => {
  // Solution code here...
  let evens = arr.filter( function(n,i) {
...
const filterStringsWithVowels = (arr) => {
    // Solution code here...
    // let re = /\w[aeiouAEIOU\s]\w[a-zA-Z\s]\w[aeiouAEIOU\s]\D\b/g;
    let re=/[^aeiouAEIOU][a-zA-Z]*[aeiouAEIOU]\w+|[aeiouAEIOU]/g;
  const parents = arr.filter(person => person=re.test(arr));
  console.log(parents)
  return parents;
